...
@MainActor protocol NotificationCenterProcessResolving: AnyObject {
    ...
    func startMonitoring(_ changed: @escaping () -> Void)
    func stopMonitoring()
}
...
@MainActor final class NotificationCenterProcessResolver: NotificationCenterProcessResolving {
    static let bundleIdentifiers = ["com.apple.notificationcenterui", "com.apple.NotificationCenter"]
    static let fallbackNames = ["NotificationCenter", "Notification Center"]
