...
DockCat's exact bundle identifier and known overlay/simulator/URL structural identifiers are excluded. Display name alone is never an exclusion signal. Full appeared/updated/disappeared reconciliation, native dismissal, and persistent presentation policy remain deferred to issue #70.
